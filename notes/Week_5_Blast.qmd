...
date: 2025-09-30
description: "Blast"
categories: ["Blast", "Homologous Genes"]
...
<div class="pdf-actions">
  <a class="btn btn-primary"  href="../pdfs/Week_5_Blast.pdf" target="_blank" rel="noopener">Open in new tab</a>
  <a class="btn btn-outline-secondary" href="../pdfs/Week_5_Blast.pdf" download>Download PDF</a>
</div>

<div id="pdf-container">
  <!-- Use <object> for better Safari behavior; provide a fallback link -->
  <object id="pdf-viewer"
          data="../pdfs/Week_5_Blast.pdf"
          type="application/pdf">
    <p>Can’t display the PDF here. <a href="../pdfs/Week_5_Blast.pdf">Open the file</a>.</p>
  </object>
</div>
