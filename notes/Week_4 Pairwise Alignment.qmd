---
title: "Week 4: Pairwise Alignment"
date: 2025-09-23
description: "Pairwise Alignment"
categories: ["Pairwise Alignment"]
...
<div class="pdf-actions">
  <a class="btn btn-primary"  href="../pdfs/Week_4 Pairwise Alignment.pdf" target="_blank" rel="noopener">Open in new tab</a>
  <a class="btn btn-outline-secondary" href="../pdfs/Week_4 Pairwise Alignment.pdf" download>Download PDF</a>
</div>

<div id="pdf-container">
  <!-- Use <object> for better Safari behavior; provide a fallback link -->
  <object id="pdf-viewer"
          data="../pdfs/Week_4 Pairwise Alignment.pdf"
          type="application/pdf">
    <p>Can’t display the PDF here. <a href="../pdfs/Week_4 Pairwise Alignment.pdf">Open the file</a>.</p>
  </object>
</div>
