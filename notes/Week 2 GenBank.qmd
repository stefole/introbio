...
<div class="pdf-actions">
  <a class="btn btn-primary"  href="../pdfs/Week 2 GenBank.pdf" target="_blank" rel="noopener">Open in new tab</a>
  <a class="btn btn-outline-secondary" href="../pdfs/Week 2 GenBank.pdf" download>Download PDF</a>
</div>

<div id="pdf-container">
  <!-- Use <object> for better Safari behavior; provide a fallback link -->
  <object id="pdf-viewer"
          data="../pdfs/Week 2 GenBank.pdf"
          type="application/pdf">
    <p>Can’t display the PDF here. <a href="../pdfs/Week 2 GenBank.pdf">Open the file</a>.</p>
  </object>
</div>
